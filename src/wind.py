...
Provided by the AERO60492 instructors
...
class Wind:
    ...
    def step(self, dt):
        ...
        if (self.t - self.last_gust_t0) > random.uniform(
            0, 1 / (self.k_gusts + 0.1)
        ):
            ...
            self.gust_params.append(
                {"theta": theta, "wg0": wg0, "lg": lg, "t0": self.t}
            )
